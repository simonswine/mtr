...
am_mtr_OBJECTS = mtr.$(OBJEXT) net.$(OBJEXT) dns.$(OBJEXT) asn.$(OBJEXT) \
	raw.$(OBJEXT) split.$(OBJEXT) display.$(OBJEXT) \
	report.$(OBJEXT) getopt.$(OBJEXT) getopt1.$(OBJEXT) \
	select.$(OBJEXT)
mtr_OBJECTS = $(am_mtr_OBJECTS)
mtr_LDADD = $(LDADD)
DEFAULT_INCLUDES = -I. -I$(srcdir) -I. -I/usr/include/glib-2.0 -I/usr/lib/glib-2.0/include
...
ACLOCAL = ${SHELL} /home/christian/mtr/missing --run aclocal-1.9
AMDEP_FALSE = #
AMDEP_TRUE = 
AMTAR = ${SHELL} /home/christian/mtr/missing --run tar
AUTOCONF = ${SHELL} /home/christian/mtr/missing --run autoconf
AUTOHEADER = ${SHELL} /home/christian/mtr/missing --run autoheader
AUTOMAKE = ${SHELL} /home/christian/mtr/missing --run automake-1.9
AWK = mawk
CC = gcc
CCDEPMODE = depmode=gcc3
CFLAGS = -g -O2 -pthread -I/usr/include/atk-1.0 -I/usr/include/pango-1.0 -I/usr/include/gio-unix-2.0/ -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include -I/usr/include/freetype2 -I/usr/include/libpng12 -I/usr/include/gtk-2.0 -I/usr/lib/gtk-2.0/include -I/usr/include/cairo -I/usr/include/gdk-pixbuf-2.0 -I/usr/include/pixman-1   -Wall -Wno-pointer-sign
CPP = gcc -E
CPPFLAGS = 
CURSES_OBJ = curses.o
CYGPATH_W = echo
...
LDFLAGS = 
LIBOBJS = 
LIBS = -lresolv -lm -ltermcap  -pthread -L/usr/lib/x86_64-linux-gnu -lgtk-x11-2.0 -lgdk-x11-2.0 -latk-1.0 -lgio-2.0 -lpangoft2-1.0 -lpangocairo-1.0 -lgdk_pixbuf-2.0 -lm -lcairo -lpango-1.0 -lfreetype -lfontconfig -lgobject-2.0 -lgmodule-2.0 -lgthread-2.0 -lrt -lglib-2.0   -lm -lglib-2.0
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/christian/mtr/missing --run makeinfo
OBJEXT = o
PACKAGE = mtr
PACKAGE_BUGREPORT = 
PACKAGE_NAME = 
...
install_sh = /home/christian/mtr/install-sh
